...
If you prefer direct X11 instead of the browser workflow, use the launchers in `legacy_launchers/`. See [legacy_launchers/README.md](https://github.com/AMReX-Codes/Amrvis-container/tree/main/legacy_launchers) for details.
